...
orderbook = pd.DataFrame(
    {
        "Price" if args.lang == "en" else "Giá": prices,
        "Volume" if args.lang == "en" else "Khối lượng": volumes,
    }
)
...
title_11 = (
    ...
    if args.lang == "en"
    else "Bước giá - Khối lượng (Order Book / Volume Profile)"
)
...
title_12 = (
    "Net Foreign Trade Flow"
    if args.lang == "en"
    else "Dòng tiền Khối Ngoại (Net Foreign Trade)"
)
xlabel_12 = "Trading Day" if args.lang == "en" else "Ngày giao dịch"
ylabel_12 = (
    "Net Buy Value (Bn VND)" if args.lang == "en" else "Giá trị mua ròng (Tỷ VNĐ)"
)
...
title_13 = (
    "Market Sentiment" if args.lang == "en" else "Tâm lý Thị trường (Market Sentiment)"
)
