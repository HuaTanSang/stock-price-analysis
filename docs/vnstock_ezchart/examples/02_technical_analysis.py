...
title_6 = (
    "Technical Analysis: Candlestick, SMA20/50 & RSI"
    if args.lang == "en"
    else "Phân tích Kỹ thuật: Nến Nhật, SMA20/50 & RSI"
)
...
title_13 = (
    "Monthly Returns Seasonality (Boxplot)"
    if args.lang == "en"
    else "Tính Chu kỳ: Phân bổ Lợi nhuận theo Tháng (Boxplot)"
)
